...
VALUES 
	    ...
	    ('1', 'That\'s the Spirit', 'https://images-na.ssl-images-amazon.com/images/I/516HOT7Vj3L._AC_SX466_.jpg', '2015-07-24', CURDATE());
...
VALUES 
        ...
        ('20', '1', 'Doomed', '197', '1', 'blabla', 'https://www.youtube.com/watch?v=5Oc0ja19_GU', CURDATE(), '2012-02-04'),
		('20', '1', 'Happy Song', '215', '2', 'blibli', 'https://www.youtube.com/watch?v=GBRAnuT48qo', CURDATE(), '2012-02-04'),
		('20', '1', 'Throne', '236', '3', 'blublu', 'https://www.youtube.com/watch?v=Ow_qI_F2ZJI', CURDATE(), '2012-02-04'),
		('20', '1', 'True Friends', '247', '4', 'bleble', 'https://www.youtube.com/watch?v=BpmJh2CjSIA', CURDATE(), '2012-02-04'),
		('20', '1', 'Follow You', '254', '5', 'blsbls', 'https://www.youtube.com/watch?v=RqQKhSzThyc', CURDATE(), '2012-02-04'),
		('20', '1', 'What You Need', '221', '6', 'popopo', 'https://www.youtube.com/watch?v=k48k3BUdcXQ', CURDATE(), '2012-02-04'),
		('20', '1', 'Avalanche', '239', '7', 'blabla', 'https://www.youtube.com/watch?v=33hVOJdVw8E', CURDATE(), '2012-02-04'),
		('20', '1', 'Run', '222', '8', 'blabla', 'https://www.youtube.com/watch?v=57F_JVBkyks', CURDATE(), '2012-02-04'),
		('20', '1', 'Drown', '267', '9', 'blabla', 'https://www.youtube.com/watch?v=TkV5709EG5M', CURDATE(), '2012-06-04'),
		('20', '1', 'Blasphemy', '231', '10', 'blabla', 'https://www.youtube.com/watch?v=HYd9B6YvIHM', CURDATE(), '2012-02-04'),
		('20', '1', 'Oh No', '315', '11', 'blabla', 'https://www.youtube.com/watch?v=SEp9Kh0M4f0', CURDATE(), '2012-02-04');

        
INSERT INTO `Playlists` (title,media,uploaded_at,created_at)
VALUES 
		("Favorites", "https://25yearslatersite.com/wp-content/uploads/2019/12/favorites.jpg", CURDATE(), "2020-09-13"),
		("Avenged Bangers", "https://pbs.twimg.com/profile_images/660679456546246656/j5yxYKd0_400x400.jpg", CURDATE(), "2019-09-13");
